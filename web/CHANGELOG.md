...
## [0.7.0](https://github.com/AmirulAndalib/career-ops/compare/web-v0.6.0...web-v0.7.0) (2026-08-08)


### Features

* **compliance:** check-table-freshness.mjs — staleness validator for jurisdiction tables (closes [#2036](https://github.com/AmirulAndalib/career-ops/issues/2036)) ([1e83f67](https://github.com/AmirulAndalib/career-ops/commit/1e83f6711e5e1587fc1d220b40eb925b8ef73542))
* **oferta/apply:** immigration-status requirement overreach — jurisdiction table + posting signal + form warning ([2a681d1](https://github.com/AmirulAndalib/career-ops/commit/2a681d129a5ad2fb1b191072dac74a0a90ea6cb5))
* **oferta/apply:** jurisdiction-prohibited content signal — table + Block G + apply-form warning ([d8dac75](https://github.com/AmirulAndalib/career-ops/commit/d8dac7589b228051abe79ca3acf4014cf8b9c6fb))
* **oferta:** agency licensing check — jurisdiction table + registry pointer for agency-mediated postings (closes [#2037](https://github.com/AmirulAndalib/career-ops/issues/2037)) ([10bf77f](https://github.com/AmirulAndalib/career-ops/commit/10bf77fb7c5c2f8eb6ca1a03ba91736f5bf95ca3))
* **providers:** add VDAB zero-auth provider ([#2084](https://github.com/AmirulAndalib/career-ops/issues/2084)) ([6164384](https://github.com/AmirulAndalib/career-ops/commit/6164384768fa47b7e164e2c36f53e86b2fd620cc))
...
* **deps:** update dependency next to v16.2.11 [security] ([#2198](https://github.com/AmirulAndalib/career-ops/issues/2198)) ([b6d1c87](https://github.com/AmirulAndalib/career-ops/commit/b6d1c871d985c278af51d26fa51ef09274c1076b))
...
* **web:** add Hired to the states.ts FALLBACK so the degraded path accepts it ([#2282](https://github.com/AmirulAndalib/career-ops/issues/2282)) ([fd112c9](https://github.com/AmirulAndalib/career-ops/commit/fd112c972d23cf0028e0411f36f67b1adf5520db))
* **web:** label-aware pipeline.md reader — posted:/trust:/note: never misread as columns ([6c75d9a](https://github.com/AmirulAndalib/career-ops/commit/6c75d9aa03c919803ffe6939b2ba6f1cf7238db6))
* **web:** propagate the Hired terminal-success state across the whole dashboard ([#2250](https://github.com/AmirulAndalib/career-ops/issues/2250)) ([29503dc](https://github.com/AmirulAndalib/career-ops/commit/29503dca07c4f1725675299db48685565f159acb))
...
* **web:** resolve nested postcss and sharp advisories via overrides ([#2216](https://github.com/AmirulAndalib/career-ops/issues/2216)) ([ec02af8](https://github.com/AmirulAndalib/career-ops/commit/ec02af816abc81b500475f81bf1c2753727a1e79))
